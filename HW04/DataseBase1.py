...
lemurlink="http://fiji5.ccs.neu.edu/~zerg/lemurcgi/lemur.cgi?d=1&g=p&v="
...
AVE_DOCLEN = 493
NUM_DOCS = 84678
MESG = "Results written successfully to file- Database 1"

#cleaned up the query by removing stop words and returning the dictionary
def cleaned_queries():
  dictquery={}
  with open(queries_file, 'r') as f:
    dictquery={line.split()[0]: line.split()[1] for line in f}
##          for line in f: 
